...
public class ActionDetailActivity extends BaseActivity<ActionDetailPresenter> {
    ...
    public void setActionDetail(DiscoverDetail detail) {
        ...
        if (detail.getSubheadTitle().isEmpty()) {
            tag.setVisibility(View.INVISIBLE);
        } else {
            tag.setText(detail.getSubheadTitle());
        }
        if (detail.getImg() != null)
            image.setImageURI(Uri.parse(detail.getImg()));
