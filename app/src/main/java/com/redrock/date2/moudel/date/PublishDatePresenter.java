 ...
 */
public class PublishDatePresenter extends Presenter<PublishDateActivity> {
    public DateEdit mData = new DateEdit();

    @Override
    protected void onCreate(PublishDateActivity view, Bundle savedState) {
        super.onCreate(view, savedState);
        mData.setStyle(getView().getIntent().getIntExtra("id", 0));
    }

    @Override
    protected void onCreateView(PublishDateActivity view) {
